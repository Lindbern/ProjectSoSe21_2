...
$dest = "../ProjectSoSe21_2/speicherstände/ProjectSoSe21";
...
$directory = realpath("../ProjectSoSe21_2/speicherstände/ProjectSoSe21");
$options = array("remove_path" => $directory);
$zip->addPattern("/\.(?:json)$/", $directory, $options);
$zip->close();
}
//löscht alle existenten Export-Jsons 
array_map("unlink", glob("../ProjectSoSe21_2/speicherstände/ProjectSoSe21/*.json"));
}

//Bilder-Teil Export
if($_POST['Bilder'] == "1"){
try{
            $images_directory="../ProjectSoSe21_2/images";
...
if($_POST['Dateien'] == "1"){
try{
            $files_directory="../ProjectSoSe21_2/files";
